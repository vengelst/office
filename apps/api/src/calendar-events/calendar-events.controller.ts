/**
 * HTTP-API für Office-Termine (CalendarEvent).
 */
...
export class CalendarEventsController {
  ...
  findAll(
    ...
    return this.calendarEvents.list({ from, to, projectId, customerId });
  }

  @Get(':id')
  @ApiOperation({ summary: 'Termin laden' })
  findOne(@Param('id') id: string) {
    return this.calendarEvents.findOne(id);
  }
