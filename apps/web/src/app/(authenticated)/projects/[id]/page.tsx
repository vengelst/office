/**
 * Seite: projects / detail (Office-Web).
...
const ProjectPlansTab = dynamic(
  () =>
    import('@/components/projects/project-plans-tab').then(
      (m) => m.ProjectPlansTab,
    ),
  { loading: () => tabFallback },
);
    ...
    <div className={`space-y-6 ${printAll ? 'print-all-mode' : ''}`}>
      ...
      <Tabs value={activeTab} onValueChange={setActiveTab} data-tabs-root>
        <TabsList className="flex h-auto w-full flex-wrap justify-start gap-1">
          ...
          <TabsTrigger value="projectPlans" className="min-h-[44px]">
            {t.tabs.projectPlans}
          </TabsTrigger>
        ...
        <TabsContent value="projectPlans">
          <ProjectPlansTab projectId={id} />
        </TabsContent>
