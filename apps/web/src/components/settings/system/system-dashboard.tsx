/**
 * Dashboard-Inhalt der System-Status-Seite (Metriken, Services, Updates).
 */
...
import { ProgressBar, StatusDot } from './system-ui';
      ...
      <Dialog open={confirmOpen} onOpenChange={setConfirmOpen}>
        <DialogContent>
          ...
          <DialogFooter>
            ...
            <Button onClick={onUpdate}>{t.updates.confirmButton}</Button>
          </DialogFooter>
        </DialogContent>
      </Dialog>
    </div>
